...
const Register = () => {
    ...
    const { signUpUser, signUpWithGoogle }  = useAuth();
                        ...
                        {/* <div className="w-full max-w-sm mx-auto bg-gray-100 shadow-md rounded pt-6 px-8 pb-8 mb-4"> */}
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
            ...
            
                                {
                                    ...
                                    {/* LOGIN BUTTON */}
                                <div>
                                    <button className='bg-primary w-full  text-white font-bold py-2 px-8 rounded-md focus:outline-none'>
                                         Sign Up 
                                    </button>
                                </div>
                                </form>
                                
                                        <p className='align-baseline text-center font-medium mt-4 text-sm'>Already have an account? <Link to="/login" className='text-red-500'>Login</Link></p>
