                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-5 mt-3">
                                                <div className="inline-flex items-center mb-4">
                                                    ...
                                                    <label htmlFor="billing_same" className="ml-2 ">I am aggree to the <Link className='underline underline-offset-2 text-primary'>Terms & Conditions</Link> and <Link className='underline underline-offset-2 text-primary'>Shoping Policy.</Link></label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="md:col-span-5 text-right">
                                                <div className="inline-flex items-end w-full">
                                                    <button
                                                        disabled={!isChecked}
                                                        className="bg-primary w-full text-white font-bold py-2 px-4 rounded">Place an Order</button>
                                                </div>
                                            </div>
